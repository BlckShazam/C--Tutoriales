...
/*
	void Start () {
		...
		// todos inicializados al valor 1:
				int[] numerosEnteros = {1, 1, 1, 1, 1};

		
		// 2b. Saca por log el numero de elementos que tiene el array:
		// Pista: .Length
				Debug.Log(numerosEnteros.Length);
		...
		// 2d. Saca por log el valor de cada una de las cinco casillas del array:
				Debug.Log(numerosEnteros[0]);
				Debug.Log(numerosEnteros[1]);
				Debug.Log(numerosEnteros[2]);
				Debug.Log(numerosEnteros[3]);
				Debug.Log(numerosEnteros[4]);
	...
	*/
	...
	void Start () {
		...
		// con cinco mensajes que digan predicciones del futuro:
				...
				string[] mensajeFuturo = { "Llovera", "Hara frio", "Dormiras", "Hara granizo", "aun mas calor pisha" };
		...
		// 3b. Saca por log el valor almacenado en la posicion "numeroAleatorio":
				...
				Debug.Log (mensajeFuturo[numeroAleatorio]);
